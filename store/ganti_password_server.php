<?php
    ...
    $data_user  = $db->getFieldValue("mokes_server", array("*"), array("id" => $_SESSION[SESSION_NAME]["id"])); 
    ...
    $db->mysql_update("mokes_server", array("password" => $db->acakPassword($_POST["new_password"])), array("id" => $data_user[0]["id"]));
    $db->mysql_close();
