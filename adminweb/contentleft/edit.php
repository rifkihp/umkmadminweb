<?php
    ...
    $sql = "SELECT id FROM widget WHERE letak='Kiri' AND urutan<'".$data[0]["urutan"]."' ORDER BY urutan DESC LIMIT 0, 1";
    $db->mysql_query($sql, $rs_num, $rs);
    $data[0]["id_widget_posisi"] = $rs[0]["id"];
    ...
    $smarty->assign("sub_title", "Edit Left Widget");
