<?php
    ...
    $id_header   = $_POST["id"];
    $data_header = $db->getFieldValue("customer_order_header", array("*"), array("id" => $id_header));
    $id_member   = $data_header[0]["id_member"];
    $id_guest    = $data_header[0]["id_guest"];
    $kode_order  = $data_header[0]["kode"]; 
    ...
    //SAVE DETAIL PESANAN
    $detail = $db->getFieldValue("customer_order_detail", array("*"), array("id_header" => $id_header));
    ...
    $db->mysql_delete("customer_order_detail", array("id_header" => $id_header));
    ...
    $subject = "Perubahan Pemesanan";
    $detail_message = "Admin telah melakukan perubahan pemesanan Anda untuk nomer pemesanan <b>#".$data_header[0]["kode"]."</b>.";
    ...
    //PUSH NOTIFICATION:
    $data_pemesanan[0]["tanggal_jam"] = $tanggal_jam;
    $data_pemesanan[0]["judul"] = "Validasi Pembayaran";
    $data_pemesanan[0]["konten"] = "Admin telah melakukan perubahan pemesanan Anda untuk nomer pemesanan #".$data_header[0]["kode"].".";
    ...
    if(count($gcmRegIds)>0) {
        ...
        $gcm = new GCM();
        $message = json_encode($data_pemesanan[0]);            
    ...
    $_SESSION["alert_success"] = "Edit data pesanan berhasil.";
    $db->mysql_close();
