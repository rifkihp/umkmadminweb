<?php
    ...
    $data = $db->getFieldValue("banner", array("id", "nama", "judul", "detail", "sub_detail_1", "sub_detail_2", "filename", "gambar", "is_aktif AS status"), array("id" => $id));
    ...
    $db->mysql_close();
    $smarty->display(BACK_END_TEMPLATE_PATH."/pengaturan_website/edit.html");    