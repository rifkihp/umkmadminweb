<?php
    ...
    foreach($row as $i => $value) {
        ...
        $sql_update = "UPDATE `channel_send` SET channel_id='".$id."' WHERE message_id<>'".$id."' AND `text`='".addslashes($text)."' AND DATE_FORMAT(tanggal_jam, '%Y-%m-%d')=DATE_FORMAT('".$tanggal_jam."', '%Y-%m-%d')"; // '".$tanggal_jam."' BETWEEN DATE_ADD(tanggal_jam, INTERVAL -30 SECOND) AND DATE_ADD(tanggal_jam, INTERVAL 600 SECOND)";
