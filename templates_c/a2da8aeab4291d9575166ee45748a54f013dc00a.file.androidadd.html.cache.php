<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-02-24 08:53:20
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5e27fa62a37ff4_15977657',
  'variables' => 
  array (
    'isEdit' => 0,
    'data' => 0,
...
<?php if ($_valid && !is_callable('content_5e27fa62a37ff4_15977657')) {function content_5e27fa62a37ff4_15977657($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['include_tpl']->value)."/includes/head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
...
" name="harga" class="form-control harga" placeholder="" /></td>' +
	                        '<td style="padding: 5px;"><div style="text-align: center;  white-space: nowrap;"><?php if ($_smarty_tpl->tpl_vars['no']->value==1) {?><div id="btn_tambah_grosir" class="btn btn-primary">+</div><?php } elseif ($_smarty_tpl->tpl_vars['no']->value>1) {?><div class="btn btn-danger hapus_grosir">-</div><?php }?></div></td>' +
	                    '</tr>';
...
" name="jumlah" class="form-control harga" placeholder="" /></td>' +
	                        '<td style="padding: 5px;"><div style="text-align: center;  white-space: nowrap;"><?php if ($_smarty_tpl->tpl_vars['no']->value==1) {?><div id="btn_tambah_varian" class="btn btn-primary">+</div><?php } elseif ($_smarty_tpl->tpl_vars['no']->value>1) {?><div class="btn btn-danger hapus_varian">-</div><?php }?></div></td>' +
	                    '</tr>';
