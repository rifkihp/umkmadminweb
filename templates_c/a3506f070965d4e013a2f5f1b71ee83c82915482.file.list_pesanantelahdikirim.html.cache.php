<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-04-26 10:21:05
         compiled from "../../../templates/back-end/penguin/pesanandalamproses/list_pesanantelahdikirim.html" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5ea4fe21175a23_99949308',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ea4fe21175a23_99949308')) {function content_5ea4fe21175a23_99949308($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['include_tpl']->value)."/includes/head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
...
">Beranda</a></li>
						<li><a href="<?php echo $_smarty_tpl->tpl_vars['adminweburl']->value;?>
/pesanandalamproses/pesanantelahdikirim/"><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</a></li>
...
" class="form-control tanggal col-xx-12" name="tanggal_dari" placeholder="Klik Untuk Memilih Tanggal" />
												</td>
...
">
                                            ...
                                            <td align="center"><?php echo $_smarty_tpl->tpl_vars['entry']->value['no_trx'];?>
</td>
                                            <td align="left"><?php if ($_smarty_tpl->tpl_vars['entry']->value['id_member']==0) {?>Tamu<?php } else {
echo $_smarty_tpl->tpl_vars['entry']->value['nama_member'];
}?></td>
                                            <td align="left">
                                                <?php if ($_smarty_tpl->tpl_vars['entry']->value['is_dropship']=='Y') {?><span class="btn label bg-red"><small>Dropship</small></span><?php }?>
                                                <?php if ($_smarty_tpl->tpl_vars['entry']->value['pembayaran']!='') {?><span class="btn label bg-green"><small><?php echo $_smarty_tpl->tpl_vars['entry']->value['pembayaran'];?>
</small></span><?php }?>
                                            </td>
                                            <td align="left"><?php echo $_smarty_tpl->tpl_vars['entry']->value['no_resi'];?>
</td>
...
" class="btn btn-default detail">Cetak</div>&nbsp;&nbsp;<?php }?>
                                                    <?php if (in_array('E',$_smarty_tpl->tpl_vars['array_akses']->value)) {?><div id_select="<?php echo $_smarty_tpl->tpl_vars['entry']->value['id'];?>
...
/pemesanan/edit.php?id='+id+'&from_page=pesanantelahdikirim';
            ...
            $( ".detail" ).click(function() {
                ...
                window.open('<?php echo $_smarty_tpl->tpl_vars['adminweburl']->value;?>
/cetak.php?kode='+id,'cetak_faktur','width=715,height=565,toolbar=no,menubar=no,scrollbars=yes');
