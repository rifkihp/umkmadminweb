...
jQuery(document).ready(function($) {	
	...
	$(".theme").on("click", function(){
		var theme = base_tpl_url + $(this).attr('id').toLowerCase()+".css";
		$('#theme').attr('href', theme);
		$.post(base_url + "includes/php/tplSetting.php", {"tpl-theme": theme});
	});
...
//		$('.material-menu').removeClass('left-aside-toggle');
//	} else if (width <= 480) {
//		$('.material-menu').removeClass('left-aside-toggle');
//	}		
