<?php /*%%SmartyHeaderCode:3215929915e9d3e76a83801-73956210%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f9fcefe6894f63d549034a6ea22163ca1356d334' => 
    array (
      0 => '..\\..\\templates\\back-end\\penguin\\jenisuser\\list.html',
      1 => 1538456120,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3215929915e9d3e76a83801-73956210',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5e9d407d43fb33_96231520',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e9d407d43fb33_96231520')) {function content_5e9d407d43fb33_96231520($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
            ...
            <div class="header">
                <div class="header-content">
                    <div class="page-title">
                        <i class="icon-table position-left"></i> Group User
                    </div>
                    <ul class="breadcrumb">
                        <li><a href="http://192.168.43.183/laundry/adminweb">Home</a></li>
                        <li><a href="http://192.168.43.183/laundry/adminweb/dashboard/">Group User</a></li>
                        <li class="active">List of Group User</li>
                    </ul>					
                </div>
            </div>		
            <!--/Page Header-->
                ...
                <div class="panel panel-flat" style="margin: 5px;">
                    <div class="form-group panel-body no-padding-bottom">
                        ...
                        <div class="form-group">
                            <div id='btn_add' class="btn btn-primary">Baru</div>                                                            <div id='btn_aktif' class="btn btn-success disabled">Aktif</div>
