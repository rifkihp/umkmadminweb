<?php /*%%SmartyHeaderCode:15448761685e9d8c607e7263-02085201%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e965a5b10bf35517270c1342c227d0f6b41bdc56' => 
    array (
  ...
  'nocache_hash' => '15448761685e9d8c607e7263-02085201',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5e9e17ce14c183_98454544',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e9e17ce14c183_98454544')) {function content_5e9e17ce14c183_98454544($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
								...
								<div class="form-group panel-body no-padding-bottom">
									<div class="row col-md-12">                    
										...
										<div class="form-group">
											...
											<input type="text" name="first_name" value="Mama" class="form-control" />
										...
										<div class="form-group">
											...
											<input type="text" name="last_name" value="Laundry" class="form-control" />
										...
										<div class="form-group">
											...
											<input type="text" name="username" value="mama" class="form-control" />
										...
										<div class="form-group">
											...
											<div id="photo-editor">
												...
												<div style=" float: right; margin-top: 5px; margin-left: 5px; position: absolute;"><input id="fileupload_photo" type="file" name="fileupload_photo" style="display:none;" class="cropit-image-input" /><a id="upload_photo"><img src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/camera-icon.png" width="24px" height="20px" /></a></div>    
										...
										<div class="form-group">
											...
											<textarea name="alamat" class="form-control">Komp. TNI AD Jalan Kenari 6 Blok K4 No. 5</textarea>
										...
										<div class="form-group">
											...
											<input type="text" name="kode_pos" value="16455" class="form-control" />
    ...
    <script type="text/javascript">
        ...
        $(function () {           
            ...
            $('#photo-editor').cropit({
                smallImage: 'stretch',
                imageState: {
                    src: 'http://192.168.43.183/laundry/uploads/member/32619874.png'
                }
            });
            ...
            function loadKota(propinsi, kota) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'http://192.168.43.183/laundry/store/getKota.php',
            ...
            function loadKecamatan(kota, kecamatan) {
                ...
                if(kota>0) {
                    $.ajax({
                        type: 'POST',
                        url: 'http://192.168.43.183/laundry/store/getKecamatan.php',
                        data: { 'kota': kota },
                        dataType: 'json',
                        success: function(data) {
                            var store = data['topics'];
