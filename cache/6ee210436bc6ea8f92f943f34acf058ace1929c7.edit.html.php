...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5bda72cf45e6f4_69678995',
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bda72cf45e6f4_69678995')) {function content_5bda72cf45e6f4_69678995($_smarty_tpl) {?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
        ...
        <div class="panel panel-flat" style="margin: 5px;">
            <div class="form-group panel-body no-padding-bottom">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="WAHANA" class="form-control" name="kode" placeholder="" />
                </div>

                <div class="form-group">
                    <label for="nama">Nama:</label>
                    <input type="text" value="WAHANA" class="form-control" name="nama" placeholder="" />
                </div>
    ...
    <script type="text/javascript">
        $(function () {           
            ...
            $('.image-editor').cropit({
              smallImage: 'stretch',
              imageState: {
                src: 'http://laundry.id/uploads/ekspedisi/wahana_7823.png',
              }
            });
