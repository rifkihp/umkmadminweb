<?php /*%%SmartyHeaderCode:826607275ee9c6dd8a51d4-30958311%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5fa2fd0c6546994ac6aea3ac41010d00b95285de' => 
    array (
  ...
  'nocache_hash' => '826607275ee9c6dd8a51d4-30958311',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5eebf4ac9b68d9_40433641',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eebf4ac9b68d9_40433641')) {function content_5eebf4ac9b68d9_40433641($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
			...
			<div class="header">
				<div class="header-content">
					...
					<ul class="breadcrumb">
						...
						<li><a href="http://kiezie.web.id/bekamonline/adminweb/dashboard/">Produk</a></li>
                                ...
                                <div id="wrapper" class="row" style="margin: 5px;">  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="mitra" name="mitra" class="form-control">
                                            <option value="0">-- Pilih Mitra --</option>
                                                                                        <option value="145"  selected="selected" >DEDE ROHMANA</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="fileupload_foto_1" name="fileupload_foto_1" multiple />
                                                                                                                    ...
                                                                                                                    <div class="form-group">
                                            <img id="preview_foto_1" src="http://kiezie.web.id/bekamonline/uploads/produk/WhatsApp Image 2020-06-17 at 15.22.45.jpeg" style="height: 300px;" alt="1" />
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td width="100%">&nbsp;</td> 
                                                    <td nowrap>
                                                        <div id="i_loading" class="G-btn-animation" style="display: none;"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/img/loading.gif" /></div>                  
...
<!-- Page scripts -->
<script src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/bootstrap-fileinput/js/fileinput.js"></script>
<script type="text/javascript" src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/js/jquery.input.formatter.js"></script>  

<!-- include summernote -->
<link rel="stylesheet" href="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/dist/summernote.css">
<script type="text/javascript" src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/dist/summernote.js"></script>
<script type="text/javascript" src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/dist/summernote-ext-video.js"></script> 
<link href="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/datepick/jquery.datepick.css" rel="stylesheet">
<script src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/datepick/jquery.plugin.js"></script>
<script src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/datepick/jquery.datepick.js"></script>
...
<script type="text/javascript">
            $(function () {           
				...
				var files = new Array();
	            	                	                files[0] = 'WhatsApp Image 2020-06-17 at 15.22.45.jpeg';	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	                	                	            	            
