<?php /*%%SmartyHeaderCode:10682499325bda6ba04a4b59-76977339%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a520c6c29ea795a11919b3f3909f5cf948d99661' => 
    array (
      0 => '../../templates/back-end/penguin/pengaturan_toko/edit.html',
      1 => 1538456117,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '10682499325bda6ba04a4b59-76977339',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5d3edf6f284ae0_54625819',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d3edf6f284ae0_54625819')) {function content_5d3edf6f284ae0_54625819($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
    ...
    <div class="header">
        <div class="header-content">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="http://laundry.id/adminweb/pengaturan_toko/">Pengaturan</a></li>
            ...
            <div class="form-group panel-body no-padding-bottom">
                ...
                <div class="form-group tab-content">
                    <div class="tab-pane fade active in" id="profiltoko">
                        ...
                        <div class="form-group">
                            <div id="i_loading_profiltoko" class="G-btn-animation" style="display: none;"><img src="http://laundry.id/templates/back-end/penguin/assets/img/loading.gif" /></div>                  
                    ...
                    <div class="tab-pane fade" id="hubungikami">
                        ...
                        <div class="form-group">
                            <div id="i_loading_hubungikami" class="G-btn-animation" style="display: none;"><img src="http://laundry.id/templates/back-end/penguin/assets/img/loading.gif" /></div>                  
                    ...
                    <div class="tab-pane fade" id="sosialmedia">
                        ...
                        <div class="form-group">
                            <div id="i_loading_sosialmedia" class="G-btn-animation" style="display: none;"><img src="http://laundry.id/templates/back-end/penguin/assets/img/loading.gif" /></div>                  
