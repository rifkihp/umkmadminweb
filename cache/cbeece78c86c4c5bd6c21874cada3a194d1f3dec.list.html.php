...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5d6880f9ef84e5_08676359',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d6880f9ef84e5_08676359')) {function content_5d6880f9ef84e5_08676359($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
    ...
    <div class="header">
        <div class="header-content">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="http://laundry.id/adminweb/pengaturan/">Konfirmasi Pembayaran</a></li>
                    ...
                    <tr>
                        ...
                        <td width="80%">
                            <select id="filter_status" class="form-control" name="status">
                                ...
                                <option value="0" selected="selected">Status Menunggu</option>              
...
<script type="text/javascript" src="http://laundry.id/templates/back-end/penguin/js/jzoom.js"></script>
<!-- iCheck -->
