...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_614a5bc56a9eb9_93353492',
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_614a5bc56a9eb9_93353492')) {function content_614a5bc56a9eb9_93353492($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
			...
			<div class="header">
				<div class="header-content">
					...
					<ul class="breadcrumb">
						...
						<li><a href="http://localhost/sogi-admin-web-master/adminweb/pesanandalamproses/pesananperludikirim/">Pesanan Perlu Dikirim</a></li>
...
//            $('.tanggal').datepick({ dateFormat: 'dd-mm-yyyy' });
            ...
            $( ".edit" ).click(function() {
                ...
                window.location='http://localhost/sogi-admin-web-master/adminweb/pemesanan/edit.php?id='+id+'&from_page=pesananperludikirim';
