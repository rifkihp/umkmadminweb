...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5e27f69d761298_41249332',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e27f69d761298_41249332')) {function content_5e27f69d761298_41249332($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
                    ...
                    <ul class="pull-right top-right-icons">
                        ...
                        <li class="dropdown user-dropdown" style="border-left: 1px solid #ffffff;padding-left: 10px">
                            ...
                            <div class="dropdown-menu">	
                                ...
                                <h5 class="text-center"><b>Hi! </b></h5>
                                <ul class="more-apps">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="footer-left">
                    <a href="http://localhost/laundry" target="_blank"></a>&nbsp;
                </div>
            </div>				
        </div>
    </div>
