...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5bf28e23d244a2_64728096',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bf28e23d244a2_64728096')) {function content_5bf28e23d244a2_64728096($_smarty_tpl) {?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
			...
			<div class="header">
				<div class="header-content">
					<div class="page-title">
						<i class="icon-table position-left"></i> Voucher
					</div>
					<ul class="breadcrumb">
						<li><a href="http://laundry.id/adminweb">Beranda</a></li>
						<li><a href="http://laundry.id/adminweb/dashboard/">Voucher</a></li>
							...
							<div class="panel panel-flat" style="margin: 5px;">
								<div class="form-group panel-body no-padding-bottom">
									...
									<div class="form-group">
										...
										<input type="text" value="" class="form-control pickadate" name="batas_valid" placeholder="" />
