...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5d687f8c47dc44_29433487',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d687f8c47dc44_29433487')) {function content_5d687f8c47dc44_29433487($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
            ...
            <div id="page-inner">
                ...
                <div class="row">                    
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="000080" class="form-control" name="kode" readonly placeholder="Auto" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="13-09-2018" class="form-control pickadate" name="tanggal" />
                    ...
                    <div id="panel_member" class="form-group" >
                        ...
                        <input type="text" value="vera " class="form-control" name="nama_member" />

                        <input type="hidden" value="44" name="id_member" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="ee" class="form-control" name="kepada" />
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="alamat" style="height: 80px;">ed</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="081373011822" class="form-control" name="no_hp" />
                    ...
                    <div class="form-group">
                        ...
                        <select id="header_prop" name="propinsi" class="form-control">
                            ...
                            <option value="0">-- Pilih Propinsi --</option>
                                ...
                                <option value="5"  selected="selected" >DI Yogyakarta</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="header_kota" name="kota" class="form-control">
                            ...
                            <option value="0">-- Pilih Kota --</option>
                                ...
                                <option value="210"  selected="selected" >Kulon Progo</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="header_kecamatan" name="kecamatan" class="form-control">
                            ...
                            <option value="0">-- Pilih Kecamatan --</option>
                                ...
                                <option value="2930" >Galur</option>

                            
                                <option value="2931" >Girimulyo</option>

                            
                                <option value="2932" >Kalibawang</option>

                            
                                <option value="2933" >Kokap</option>

                            
                                <option value="2934" >Lendah</option>

                            
                                <option value="2935" >Nanggulan</option>

                            
                                <option value="2936"  selected="selected" >Panjatan</option>

                            
                                <option value="2937" >Pengasih</option>

                            
                                <option value="2938" >Samigaluh</option>

                            
                                <option value="2939" >Sentolo</option>

                            
                                <option value="2940" >Temon</option>

                            
                                <option value="2941" >Wates</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="31248" class="form-control" name="kode_pos" />
                    ...
                    <div class="form-group">
                        ...
                        <select id="header_kurir" name="kurir" class="form-control">
                                ...
                                <option value="TIKI"  selected="selected" >TIKI</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="header_layanan" name="layanan"  class="form-control">
                                ...
                                <option value="ECO" >Economy Service (ECO)</option>

                            
                                <option value="REG" >Regular Service (REG)</option>
                            ...
                            <table  id="tblDetail_produk" class="table table-striped table-bordered table-hover" width="100%">
                                ...
                                <tbody id="detail_produk">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 0; margin: 0;"><input type="hidden" name="etd" value="4" /><input id="header_tarif" type="text" value="262,500" class="form-control harga" name="ongkir" style="text-align: right; font-weight: bold;" disabled="disabled" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 0; margin: 0;"><input id="header_total" type="text" value="1,102,500" class="form-control" name="total" style="text-align: right; font-weight: bold;" disabled="disabled" /></td>
                    ...
                    <div class="form-group" id="jumlah_transfer" >
                        ...
                        <input type="text" name="jumlah_transfer" value="1,000,000" class="form-control harga" />
...
//            $('.tanggal').datepick({ dateFormat: 'dd-mm-yyyy' });
            ...
            $('[name=nama_member]').autocomplete({
                ...
                source: function( request, response ) {
                    ...
                    $.ajax({
                        ...
                        url: 'http://laundry.id/store/memberDataStore.php',
            ...
            $('[name=kepada]').autocomplete({
                ...
                source: function( request, response ) {
                    ...
                    $.ajax({
                        ...
                        url: 'http://laundry.id/store/getAlamatMember.php',
                ...
                var record = 
                    ...
                    '<tr>' +
                        ...
                        '<td align="center">' +
                            ...
                            '<input type="text" value="tas mj" class="form-control nama_produk" name="nama" />' +                                                

                            '<input type="hidden" value="29" name="id_produk" />' +

                            '<input type="hidden" value="1919" name="kode" />' +

                            '<input type="hidden" value="1000" name="berat" />' +

                            '<input type="hidden" value="90000" name="harga_beli" />' +

                            '<input type="hidden" value="" name="list_grosir" />' +

                            '<input type="hidden" value="120000" name="harga_jual_ori" />' +
                        ...
                        '<td align="center">' +
                            ...
                            '<select class="form-control" name="ukuran_warna">' +                            
                                    ...
                                    '<option value="20X20X20|TEST" selected="selected" >20X20X20 / TEST</option>' +
                        ...
                        '<td align="center">' +
                            ...
                            '<input type="text" value="7" class="form-control harga jumlah" name="jumlah" style="text-align: right;" />' +

                        '</td>' +

                        '<td align="center">' +

                            '<input type="text" value="120,000" class="form-control harga" name="harga_jual" style="text-align: right;"  disabled="disabled" />' +
                        ...
                        '<td align="center">' +
                            ...
                            '<input type="text" value="120,000" class="form-control harga" name="sub_total" style="text-align: right;" disabled="disabled" />' +

                        '</td>' +

                        '<td align="center">' +

                            '<input type="text" value="840,000" class="form-control harga" name="grand_total" style="text-align: right;"  disabled="disabled" />' +
            ...
            setQtyChangeListeners();
                ...
                array_tarif.push({ service: 'ECO', description: 'Economy Service', cost:[{ value: '30000', tarif: 'Rp 30,000', etd: '4' }] });

                

                array_tarif.push({ service: 'REG', description: 'Regular Service', cost:[{ value: '37000', tarif: 'Rp 37,000', etd: '3' }] });

            
            for(var key in array_tarif) {

                if(array_tarif[key]['service']=='REGULER SERVICE') {
                ...
                $('.nama_produk').autocomplete({
                    ...
                    source: function( request, response ) {
                        ...
                        $.ajax({
                            ...
                            url: 'http://laundry.id/store/produkDataStore.php',
            ...
            function loadKecamatan(kota, kecamatan) {
                ...
                if(kota>0) {
                    ...
                    $.ajax({
                        ...
                        url: 'http://laundry.id/store/getKecamatan.php',
            ...
            function loadLayanan(kurir, kecamatan, layanan) {
                ...
                if(kecamatan>0 && kurir!='') {
                    ...
                    $.ajax({
                        ...
                        url: 'http://laundry.id/store/getLayanan.php',
            ...
            function loadTarif(kurir, kecamatan, layanan) {
                ...
                if(kecamatan>0 && kurir!='') {
                    ...
                    $.ajax({
                        ...
                        url: 'http://laundry.id/store/getTarif.php',
