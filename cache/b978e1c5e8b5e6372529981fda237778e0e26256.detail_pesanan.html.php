...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5d39203cdc6b07_15934988',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d39203cdc6b07_15934988')) {function content_5d39203cdc6b07_15934988($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
					...
					<div class="col-md-12">
						<div class="panel panel-flat">
							<div class="panel-heading">
								...
								<h5 class="panel-title">List of Customer</h5>				
							</div>
   ...
   <script type="text/javascript">
        ...
        $(function () {
            ...
            $( "#btn_cari" ).click(function() {                
                ...
                window.location='detailpesanan.php?id=131'+
            ...
            $( "#ekspor_xls" ).click(function() {
                ...
                $.ajax({
                    ...
                    url: 'ekspor.php?id=131&tanggal_dari='+tanggal_dari+'&tanggal_sampai='+tanggal_sampai,
            ...
            $( "#ekspor_pdf" ).click(function() {
                ...
                var url = 'cetak.php?id=131&tanggal_dari='+tanggal_dari+'&tanggal_sampai='+tanggal_sampai;
