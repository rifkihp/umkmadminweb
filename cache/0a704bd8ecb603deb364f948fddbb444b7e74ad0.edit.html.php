...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5c5bec43d0afc9_26849018',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c5bec43d0afc9_26849018')) {function content_5c5bec43d0afc9_26849018($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
								...
								<div class="form-group panel-body no-padding-bottom">
									<div class="row col-md-12">                    
										...
										<div class="form-group">
											...
											<input type="text" name="first_name" value="sanjung" class="form-control" />
										...
										<div class="form-group">
											...
											<input type="text" name="last_name" value="sutria" class="form-control" />
										...
										<div class="form-group">
											...
											<input type="text" name="no_hp" value="081272911030" class="form-control" />
										...
										<div class="form-group">
											...
											<input type="text" name="email" value="sanjunggip@gmail.com" class="form-control" />
										...
										<div class="form-group">
											...
											<div id="photo-editor">
												...
												<div style=" float: right; margin-top: 5px; margin-left: 5px; position: absolute;"><input id="fileupload_photo" type="file" name="fileupload_photo" style="display:none;" class="cropit-image-input" /><a id="upload_photo"><img src="http://laundry.id/templates/back-end/penguin/assets/img/camera-icon.png" width="24px" height="20px" /></a></div>    
        ...
        $(function () {           
            ...
            $('#photo-editor').cropit({
                ...
                imageState: {
                    ...
                    src: 'http://laundry.id/uploads/member/64297183.png'
