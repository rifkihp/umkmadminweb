...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5e9db3e639dd51_99837542',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e9db3e639dd51_99837542')) {function content_5e9db3e639dd51_99837542($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
			...
			<div class="header">
				<div class="header-content">
					...
					<ul class="breadcrumb">
						...
						<li><a href="http://192.168.43.183/laundry/adminweb/dashboard/">Produk</a></li>
                            ...
                            <div class="panel-body">
                                <div id="wrapper" class="row" style="margin: 5px;">  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="mitra" name="mitra" class="form-control">
                                            <option value="0">-- Pilih Mitra --</option>
                                                                                        ...
                                                                                        <option value="143"  selected="selected" >wa laundry</option>
                                                                                    </select>
                                    </div>

                                    <div class="form-group">
                                        <label for="kode">Kode Produk:</label>
                                        <input type="text" value="pks" class="form-control" name="kode" placeholder="" />
                                    </div>

                                    <div class="form-group">
                                        <label for="nama">Nama Produk:</label>
                                        <input type="text" value="Pukis Jovita" class="form-control" name="nama" placeholder="" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="Pcs" class="form-control" name="satuan" placeholder="" />
                                    </div>

                                    <div class="form-group">
                                        <label for="harga_jual_umum">Harga Per Satuan:</label>
                                        <input type="text" value="33,000" class="form-control harga" name="harga_jual_umum" placeholder="" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="fileupload_foto_1" name="fileupload_foto_1" multiple />
                                                                                                                    ...
                                                                                                                    <div class="form-group">
                                            <img id="preview_foto_1" src="http://192.168.43.183/laundry/uploads/produk/pukis.jpg" style="height: 300px;" alt="1" />
