...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_614f7970a6a789_51347445',
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_614f7970a6a789_51347445')) {function content_614f7970a6a789_51347445($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
					...
					<div class="col-md-12">
						<div class="panel panel-flat">
							<div class="panel-heading">
								...
								<h5 class="panel-title">Edit Mitra</h5>				
							</div>
								...
								<div class="form-group panel-body no-padding-bottom">
									<div class="row col-md-12">                    
										...
										<div class="form-group">
											...
											<input type="text" name="first_name" value="AHMAD " class="form-control" />
										...
										<div class="form-group">
											...
											<input type="text" name="last_name" value="SALEH" class="form-control" />
										...
										<div class="form-group">
											...
											<input type="text" name="no_hp" value="085267311959" class="form-control" />
										...
										<div class="form-group">
											...
											<input type="text" name="email" value="ahmadsalehangsaigama@gmail.com" class="form-control" />
										...
										<div class="form-group">
											...
											<input type="text" name="username" value="saleh" class="form-control" />
										...
										<div class="form-group">
											...
											<div id="photo-editor">
												...
												<div style=" float: right; margin-top: 5px; margin-left: 5px; position: absolute;"><input id="fileupload_photo" type="file" name="fileupload_photo" style="display:none;" class="cropit-image-input" /><a id="upload_photo"><img src="http://localhost/sogi-admin-web-master/templates/back-end/penguin/assets/img/camera-icon.png" width="24px" height="20px" /></a></div>    
										...
										<div class="form-group">
											...
											<textarea name="alamat" class="form-control">KERAMASAN </textarea>
										...
										<div class="form-group">
											...
											<input type="text" name="kode_pos" value="30259" class="form-control" />
												...
												<tbody>
													...
													<tr>
														...
														<td nowrap>
															...
															<div id="i_loading" class="G-btn-animation" style="display: none;"><img src="http://localhost/sogi-admin-web-master/templates/back-end/penguin/assets/img/loading.gif" /></div>                  
    ...
    <script type="text/javascript">
        ...
        $(function () {           
            ...
            $('#photo-editor').cropit({
                smallImage: 'stretch',
                imageState: {
                    src: 'http://localhost/sogi-admin-web-master/uploads/member/91372486.png'
                }
            });
            ...
            function loadKota(propinsi, kota) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'http://localhost/sogi-admin-web-master/store/getKota.php',
            ...
            function loadKecamatan(kota, kecamatan) {
                ...
                if(kota>0) {
                    $.ajax({
                        type: 'POST',
                        url: 'http://localhost/sogi-admin-web-master/store/getKecamatan.php',
                        data: { 'kota': kota },
                        dataType: 'json',
                        success: function(data) {
                            var store = data['topics'];
            ...
            loadKota('33', '327');            loadKecamatan('327', '4618');
        });
