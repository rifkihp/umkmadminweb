<?php /*%%SmartyHeaderCode:3147812685ea38a7d0171a5-88224120%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c486b0b45abc3ebb9f7e5ee3a9294a3616d27a42' => 
    array (
  ...
  'nocache_hash' => '3147812685ea38a7d0171a5-88224120',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5ea4fb93c994b4_69108535',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ea4fb93c994b4_69108535')) {function content_5ea4fb93c994b4_69108535($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
								...
								<div class="form-group panel-body no-padding-bottom">
									<div class="row col-md-12">                    
										...
										<div class="form-group">
											...
											<input type="text" name="first_name" value="ALI" class="form-control" />
										...
										<div class="form-group">
											...
											<input type="text" name="no_hp" value="081367192902" class="form-control" />
										...
										<div class="form-group">
											...
											<input type="text" name="email" value="izumikf2019@gmail.com" class="form-control" />
										...
										<div class="form-group">
											...
											<input type="text" name="username" value="adminoa" class="form-control" />
    ...
    <script type="text/javascript">
        ...
        $(function () {           
            ...
            $('#photo-editor').cropit({
                smallImage: 'stretch',
                imageState: {
                    src: 'http://kiezie.web.id/laundry/uploads/member/87936214.png'
                }
            });
