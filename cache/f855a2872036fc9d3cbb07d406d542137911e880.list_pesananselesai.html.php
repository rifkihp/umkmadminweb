...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5c3c2af450f921_35868679',
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c3c2af450f921_35868679')) {function content_5c3c2af450f921_35868679($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
			...
			<div class="header">
				<div class="header-content">
					<div class="page-title">
						<i class="icon-table position-left"></i> Pesanan Telah Selesai
					</div>
					<ul class="breadcrumb">
						<li><a href="http://laundry.id/adminweb">Beranda</a></li>
						<li><a href="http://laundry.id/adminweb/pesanandalamproses/pesananselesai/">Pesanan Telah Selesai</a></li>
						<li class="active">Daftar Pesanan Telah Selesai</li>
					</ul>					
				</div>
			</div>		
			<!--/Page Header-->
						...
						<table class="table table-togglable table-hover">
                                ...
                                <tbody>
                                        ...
                                        <tr id="baris_50">
                                            ...
                                            <td align="left">2252534235325325</td>
                                            <td align="right">Rp. 138,000</td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="50" class="btn btn-default detail">Cetak</div>&nbsp;&nbsp;                                                    <div id_select="50" class="btn btn-success edit">Edit</div>                                                 
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_28">
                                            ...
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="28" class="btn btn-default detail">Cetak</div>&nbsp;&nbsp;                                                    <div id_select="28" class="btn btn-success edit">Edit</div>                                                 
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_8">
                                            ...
                                            <td align="left"></td>
                                            <td align="right">Rp. 207,000</td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="8" class="btn btn-default detail">Cetak</div>&nbsp;&nbsp;                                                    <div id_select="8" class="btn btn-success edit">Edit</div>                                                 
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_5">
                                            ...
                                            <td align="left">
                                                                                                <span class="btn label bg-green"><small>Transfer Bank</small></span>                                            </td>
                                            <td align="left">030073095658</td>
                                            <td align="right">Rp. 240,000</td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="5" class="btn btn-default detail">Cetak</div>&nbsp;&nbsp;                                                    <div id_select="5" class="btn btn-success edit">Edit</div>                                                 
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_2">
                                            ...
                                            <td align="left">
                                                <span class="btn label bg-red"><small>Dropship</small></span>                                                <span class="btn label bg-green"><small>Transfer Bank</small></span>                                            </td>
                                            <td align="left">A12342</td>
                                            <td align="right">Rp. 161,000</td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="2" class="btn btn-default detail">Cetak</div>&nbsp;&nbsp;                                                    <div id_select="2" class="btn btn-success edit">Edit</div>                                                 
                                                </div>
                                            </td>                                          
                                        </tr>
...
//            $('.tanggal').datepick({ dateFormat: 'dd-mm-yyyy' });
            ...
            $( ".edit" ).click(function() {
                ...
                window.location='http://laundry.id/adminweb/pemesanan/edit.php?id='+id+'&from_page=pesananselesai';
