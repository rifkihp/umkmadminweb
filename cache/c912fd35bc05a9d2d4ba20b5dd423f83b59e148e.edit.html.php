<?php /*%%SmartyHeaderCode:18038183455e27fa81752dd9-86320646%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c912fd35bc05a9d2d4ba20b5dd423f83b59e148e' => 
    array (
  ...
  'nocache_hash' => '18038183455e27fa81752dd9-86320646',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5e2801b9800703_28439013',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e2801b9800703_28439013')) {function content_5e2801b9800703_28439013($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
            ...
            <div class="panel-body">
                <div id="wrapper" class="row" style="margin: 5px;">                    
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="PKS1" class="form-control" name="kode" placeholder="" />
                    </div>

                    <div class="form-group">
                        <label for="nama">Nama Produk:</label>
                        <input type="text" value="aaa" class="form-control" name="nama" placeholder="" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="id_brand">
                            <option value="0"  selected="selected" >-- Pilih Brand --</option>                                        
                                                            <option value="4"  selected="selected" >Sophie Martin Paris</option>                                        
                    ...
                    <div class="form-group">
                        ...
                        <select multiple class="form-control" name="id_kategori" style="height: 200px;">
                                                            ...
                                                            <option style="font-weight: bold;" value="10"  selected="selected" >Fashion Pria</option>                                        
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" style="height: 80px" name="keyword">aaa</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="fileupload_foto_1" name="fileupload_foto_1" multiple />
                                                                    ...
                                                                    <div class="form-group">
                            <img id="preview_foto_1" src="http://localhost/laundry/uploads/produk/WhatsApp Image 2019-02-21 at 18.15.27.jpeg" style="height: 300px;" alt="1" />
...
<script type="text/javascript">
        ...
        $(function () {           
            ...
            var files = new Array();
                                            files[0] = 'WhatsApp Image 2019-02-21 at 18.15.27.jpeg';                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
