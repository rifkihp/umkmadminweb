<?php /*%%SmartyHeaderCode:161050855614a5ba1cd5392-85231264%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '71697bad58f1e39aa62e61a42768015126e726af' => 
    array (
      0 => '..\\..\\templates\\back-end\\penguin\\customer\\list.html',
      1 => 1595214764,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '161050855614a5ba1cd5392-85231264',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_614f79595d5447_20825996',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_614f79595d5447_20825996')) {function content_614f79595d5447_20825996($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
			...
			<div class="header">
				<div class="header-content">
					...
					<ul class="breadcrumb">
						...
						<li><a href="http://localhost/sogi-admin-web-master/adminweb/dashboard/">Pelanggan</a></li>
						...
						<table class="table table-togglable table-hover">
                                <thead>
									...
									<tbody>
                                        ...
                                        <tr id="baris_155">
                                            <td align="center"><input type="checkbox" id_select="155" name="select_155" class="select" /></td>
                                            <td align="center">1</td>
                                            <td align="left">Setiyanto Anto</td>
                                            <td align="left">anto_zal@yahoo.co.id</td>
                                            <td align="left">anto</td>
                                            <td align="left">Perumnas Betungan Rt.23 Bengkulu<br />No. HP: 085366657521</td>
                                            ...
                                            <td><div style="text-align: center;  white-space: nowrap;">
												<div id_select="155" class="btn btn-success edit">Edit</div>												<div id_select="155" class="btn btn-danger hapus">Hapus</div>											</div></td>            
                                        </tr>
                                          
                                                                        
                                        <tr id="baris_149">
                                            <td align="center"><input type="checkbox" id_select="149" name="select_149" class="select" /></td>
                                            <td align="center">2</td>
                                            <td align="left">Deki Antonio</td>
                                            <td align="left">membuatprogramxx@gmail.com</td>
                                            <td align="left">dekiantoni</td>
                                            <td align="left"><br />No. HP: 0813730118299</td>
                                        	<td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
												<div id_select="149" class="btn btn-success edit">Edit</div>												<div id_select="149" class="btn btn-danger hapus">Hapus</div>											</div></td>            
                                        </tr>
