<?php /*%%SmartyHeaderCode:1696312615eea0d8415ceb9-03306305%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8e30d52119a6a3b725f3c47d0f3528a54471fa1c' => 
    array (
  ...
  'nocache_hash' => '1696312615eea0d8415ceb9-03306305',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5eea0da494e2e5_16238085',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eea0da494e2e5_16238085')) {function content_5eea0da494e2e5_16238085($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
            ...
            <div class="navbar-right pull-right">
                <div class="clearfix">				
                    <ul class="pull-right top-right-icons">
                                ...
                                <span id="total_notif_pelanggan_baru" class="bubble">106</span>
    ...
    <div class="header">
        <div class="header-content">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="http://kiezie.web.id/bekamonline/adminweb/pengaturan_website/">Pengaturan</a></li>
        ...
        <div class="panel panel-flat" style="margin: 5px;">
            <div class="form-group panel-body no-padding-bottom">
                ...
                <div class="form-group tab-content">
                    <div class="tab-pane fade active in" id="halamanweb">
                            ...
                            <table class="table datatable table-striped">
                                ...
                                <tbody>
                                        ...
                                        <tr id="baris_8">
                                            ...
                                            <td>
                                                <div style="text-align: left;  white-space: nowrap;">
                                                    <img src="http://kiezie.web.id/bekamonline/uploads/banner/4917.png" width="190px" />
                                                </div>
                                            </td>
                                        ...
                                        <tr id="baris_7">
                                            ...
                                            <td>
                                                <div style="text-align: left;  white-space: nowrap;">
                                                    <img src="http://kiezie.web.id/bekamonline/uploads/banner/9816.png" width="190px" />
                                                </div>
                                            </td>
                                            <td align="center"><span style="font-weight: bold; color: red;">Tidak Aktif</span></td>
                                            <td>
                                        ...
                                        <tr id="baris_6">
                                            ...
                                            <td>
                                                <div style="text-align: left;  white-space: nowrap;">
                                                    <img src="http://kiezie.web.id/bekamonline/uploads/banner/7286.png" width="190px" />
                                                </div>
                                            </td>
                                            <td align="center"><span style="font-weight: bold; color: red;">Tidak Aktif</span></td>
                                            <td>
                                        ...
                                        <tr id="baris_5">
                                            ...
                                            <td>
                                                <div style="text-align: left;  white-space: nowrap;">
                                                    <img src="http://kiezie.web.id/bekamonline/uploads/banner/9728.png" width="190px" />
                                                </div>
                                            </td>
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td>
                                        ...
                                        <tr id="baris_4">
                                            ...
                                            <td>
                                                <div style="text-align: left;  white-space: nowrap;">
                                                    <img src="http://kiezie.web.id/bekamonline/uploads/banner/4317.png" width="190px" />
                                                </div>
                                            </td>
                                            <td align="center"><span style="font-weight: bold; color: red;">Tidak Aktif</span></td>
                                            <td>
                                        ...
                                        <tr id="baris_3">
                                            ...
                                            <td>
                                                <div style="text-align: left;  white-space: nowrap;">
                                                    <img src="http://kiezie.web.id/bekamonline/uploads/banner/1893.jpeg" width="190px" />
                                                </div>
                                            </td>
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td>
                                        ...
                                        <tr id="baris_2">
                                            ...
                                            <td>
                                                <div style="text-align: left;  white-space: nowrap;">
                                                    <img src="http://kiezie.web.id/bekamonline/uploads/banner/1876.jpeg" width="190px" />
                                                </div>
                                            </td>
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td>
                                        ...
                                        <tr id="baris_1">
                                            ...
                                            <td>
                                                <div style="text-align: left;  white-space: nowrap;">
                                                    <img src="http://kiezie.web.id/bekamonline/uploads/banner/1847.jpeg" width="190px" />
                                                </div>
                                            </td>
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td>
