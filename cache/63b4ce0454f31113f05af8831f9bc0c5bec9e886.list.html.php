<?php /*%%SmartyHeaderCode:10609116045e9d3e682d23f0-96916925%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '63b4ce0454f31113f05af8831f9bc0c5bec9e886' => 
    array (
  ...
  'nocache_hash' => '10609116045e9d3e682d23f0-96916925',
  'variables' => 
  array (
    'title' => 0,
    'adminweburl' => 0,
  ...
  'unifunc' => 'content_5e9d3e68997551_24957420',
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e9d3e68997551_24957420')) {function content_5e9d3e68997551_24957420($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
                ...
                <div class="clearfix">				
                    <ul class="pull-right top-right-icons">
                                ...
                                <span style="color: #ffffff">Belum Bayar / KEEP </span></a>
                                                    ...
                                                    <li class="dropdown-toggle hidden-xs" style="border-left: 1px solid #ffffff;">
                                <a href="http://192.168.43.183/laundry/adminweb/konfirmasi/list.php?status=0" class="dropdown-toggle" style="width: 100%; padding-left: 10px; padding-right: 30px;"><i class="icon-reading"></i>
                    ...
                    <li><br />&nbsp;&nbsp;&nbsp;</li>
                            ...
                            <a class="acc-parent active" href="#"><i class="icon-cart2"></i> Daftar Pesanan <span class="fa arrow"></span></a>
                                        ...
                                        <a href="http://192.168.43.183/laundry/adminweb/pesanandalamproses/pesanandibatalkan/"><i class="fa fa-bars"></i> Dibatalkan</a>
                                                                    ...
                                                                    <li>
                                        <a href="http://192.168.43.183/laundry/adminweb/pemesanan/add.php"><i class="fa fa-desktop"></i> Buat Pesanan</a>
                                    </li>
                                                                </ul>
                                                    </li>
                                            <li class="active acc-parent-li">
                            <a  href="http://192.168.43.183/laundry/adminweb/konfirmasi/"><i class="icon-foursquare"></i> Konfirmasi Pembayaran </a>
                                                    </li>
                                            <li>
                            <a class="acc-parent active" href="#"><i class="icon-book"></i> Katalog Produk <span class="fa arrow"></span></a>
                                        ...
                                        <a href="http://192.168.43.183/laundry/adminweb/product/"><i class="fa fa-archive"></i> Produk</a>
                                                                    ...
                                                                    <li>
                                        <a href="http://192.168.43.183/laundry/adminweb/stok/"><i class="fa fa-dropbox"></i> Stok</a>
                                    </li>
                                                                    <li>
                                        <a href="http://192.168.43.183/laundry/adminweb/category/"><i class="fa fa-folder"></i> Kategori</a>
                                    </li>
                                                                    <li>
                                        <a href="http://192.168.43.183/laundry/adminweb/brand/"><i class="fa fa-folder"></i> Merek</a>
                                    </li>
                                                                </ul>
                                                    </li>
                                            <li>
                            <a class="acc-parent active" href="#"><i class="icon-book"></i> PPOB <span class="fa arrow"></span></a>
                                                            <ul>
                                                                    <li>
                                        <a href="http://192.168.43.183/laundry/adminweb/ppob_produk/"><i class="fa fa-archive"></i> Produk</a>
                                    </li>
                                                                </ul>
                                                    </li>
                                            <li>
                            ...
                            <a class="acc-parent active" href="#"><i class="icon-stack-text"></i> Laporan <span class="fa arrow"></span></a>
                                        ...
                                        <a href="http://192.168.43.183/laundry/adminweb/laporan_pesanan/"><i class="fa fa-foursquare"></i> Pesanan</a>
                                                                    ...
                                                                    <li>
                                        <a href="http://192.168.43.183/laundry/adminweb/laporan_jual_ppob/"><i class="fa fa-foursquare"></i> Penjualan PPOB</a>
                                    </li>
                                                                </ul>
                                                    </li>
                                            <li>
    ...
    <div class="header">
        <div class="header-content">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="http://192.168.43.183/laundry/adminweb/pengaturan/">Konfirmasi Pembayaran</a></li>
                                    ...
                                    <table width="100%">
                                        <tr><td>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        <tr><td width="30%"><b>Pengguna</b> </td><td><b>:</b> Mama Laundry</td></tr>
                                                        <tr><td><b>Email</b> </td><td><b>:</b> kiezie08@gmail.com</td></tr>                                                                    
                                                        <tr><td><b>Tanggal</b>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>:</b> 05-04-2020 21:27:16</td></tr>
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=000082'>#000082</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_139" style="margin-top: 5px;"><input type="radio" name="status_139" id_trf="139" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_139" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                                    ...
                                                    <div align="right">
                                                        <table>
                                                            <tr><td>
                                                                ...
                                                                <div class="zoom"><img src="http://192.168.43.183/laundry/uploads/konfirmasi/17862349.jpg" height="250" width="250" /> </div>    
                                                            </td></tr>        
                                                        </table>
                                                    </div>
                                                </div>                                                            
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190214-0001'>#DPT-20190214-0001</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_138" style="margin-top: 5px;"><input type="radio" name="status_138" id_trf="138" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_138" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                                ...
                                                <div class="col-md-4">
                                                    <div align="right">
                                                        <table>
                                                            <tr><td>
                                                                    <b>Bukti Pembayaran:</b>
                                                                <div class="zoom"><img src="http://192.168.43.183/laundry/uploads/konfirmasi/62134978.jpg" height="250" width="250" /> </div>    
                                                            </td></tr>        
                                                        </table>
                                                    </div>
                                                </div>                                                            
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190128-0001'>#DPT-20190128-0001</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_137" style="margin-top: 5px;"><input type="radio" name="status_137" id_trf="137" value="2"  />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_137" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                                ...
                                                <div class="col-md-4">
                                                    <div align="right">
                                                        <table>
                                                            <tr><td>
                                                                    <b>Bukti Pembayaran:</b>
                                                                <div class="zoom"><img src="http://192.168.43.183/laundry/uploads/konfirmasi/default.jpg" height="250" width="250" /> </div>    
                                                            </td></tr>        
                                                        </table>
                                                    </div>
                                                </div>                                                            
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190122-0001'>#DPT-20190122-0001</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_136" style="margin-top: 5px;"><input type="radio" name="status_136" id_trf="136" value="2"  />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_136" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190121-0003'>#DPT-20190121-0003</a></td></tr>
                                                        <tr><td><b>Transfer</b>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>:</b> 200,000</td></tr>                                                                    
                                                    </table>
                                                </div>
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_135" style="margin-top: 5px;"><input type="radio" name="status_135" id_trf="135" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_135" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190120-0001'>#DPT-20190120-0001</a></td></tr>
                                                        <tr><td><b>Transfer</b>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>:</b> 200,000</td></tr>                                                                    
                                                    </table>
                                                </div>
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_134" style="margin-top: 5px;"><input type="radio" name="status_134" id_trf="134" value="2"  />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_134" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190118-0002'>#DPT-20190118-0002</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_133" style="margin-top: 5px;"><input type="radio" name="status_133" id_trf="133" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_133" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190118-0001'>#DPT-20190118-0001</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_132" style="margin-top: 5px;"><input type="radio" name="status_132" id_trf="132" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_132" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                                ...
                                                <div class="col-md-4">
                                                    <div align="right">
                                                        <table>
                                                            <tr><td>
                                                                    <b>Bukti Pembayaran:</b>
                                                                <div class="zoom"><img src="http://192.168.43.183/laundry/uploads/konfirmasi/13679284.jpg" height="250" width="250" /> </div>    
                                                            </td></tr>        
                                                        </table>
                                                    </div>
                                                </div>                                                            
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190117-0002'>#DPT-20190117-0002</a></td></tr>
                                                        <tr><td><b>Transfer</b>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>:</b> 200,000</td></tr>                                                                    
                                                    </table>
                                                </div>
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_131" style="margin-top: 5px;"><input type="radio" name="status_131" id_trf="131" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_131" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190117-0001'>#DPT-20190117-0001</a></td></tr>
                                                        <tr><td><b>Transfer</b>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>:</b> 500,000</td></tr>                                                                    
                                                    </table>
                                                </div>
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_130" style="margin-top: 5px;"><input type="radio" name="status_130" id_trf="130" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_130" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190116-0002'>#DPT-20190116-0002</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_129" style="margin-top: 5px;"><input type="radio" name="status_129" id_trf="129" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_129" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190116-0001'>#DPT-20190116-0001</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_128" style="margin-top: 5px;"><input type="radio" name="status_128" id_trf="128" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_128" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                                ...
                                                <div class="col-md-4">
                                                    <div align="right">
                                                        <table>
                                                            <tr><td>
                                                                    <b>Bukti Pembayaran:</b>
                                                                <div class="zoom"><img src="http://192.168.43.183/laundry/uploads/konfirmasi/93281746.jpg" height="250" width="250" /> </div>    
                                                            </td></tr>        
                                                        </table>
                                                    </div>
                                                </div>                                                            
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190115-0001'>#DPT-20190115-0001</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_127" style="margin-top: 5px;"><input type="radio" name="status_127" id_trf="127" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_127" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                                ...
                                                <div class="col-md-4">
                                                    <div align="right">
                                                        <table>
                                                            <tr><td>
                                                                    <b>Bukti Pembayaran:</b>
                                                                <div class="zoom"><img src="http://192.168.43.183/laundry/uploads/konfirmasi/87134926.jpg" height="250" width="250" /> </div>    
                                                            </td></tr>        
                                                        </table>
                                                    </div>
                                                </div>                                                            
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190112-0003'>#DPT-20190112-0003</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_126" style="margin-top: 5px;"><input type="radio" name="status_126" id_trf="126" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_126" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                                ...
                                                <div class="col-md-4">
                                                    <div align="right">
                                                        <table>
                                                            <tr><td>
                                                                    <b>Bukti Pembayaran:</b>
                                                                <div class="zoom"><img src="http://192.168.43.183/laundry/uploads/konfirmasi/79132648.jpg" height="250" width="250" /> </div>    
                                                            </td></tr>        
                                                        </table>
                                                    </div>
                                                </div>                                                            
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190112-0002'>#DPT-20190112-0002</a></td></tr>
                                                        <tr><td><b>Transfer</b>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>:</b> 200,000</td></tr>                                                                    
                                                    </table>
                                                </div>
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_125" style="margin-top: 5px;"><input type="radio" name="status_125" id_trf="125" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_125" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                                ...
                                                <div class="col-md-4">
                                                    <div align="right">
                                                        <table>
                                                            <tr><td>
                                                                    <b>Bukti Pembayaran:</b>
                                                                <div class="zoom"><img src="http://192.168.43.183/laundry/uploads/konfirmasi/98237641.jpg" height="250" width="250" /> </div>    
                                                            </td></tr>        
                                                        </table>
                                                    </div>
                                                </div>                                                            
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190112-0001'>#DPT-20190112-0001</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_124" style="margin-top: 5px;"><input type="radio" name="status_124" id_trf="124" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_124" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                                ...
                                                <div class="col-md-4">
                                                    <div align="right">
                                                        <table>
                                                            <tr><td>
                                                                    <b>Bukti Pembayaran:</b>
                                                                <div class="zoom"><img src="http://192.168.43.183/laundry/uploads/konfirmasi/69241387.jpg" height="250" width="250" /> </div>    
                                                            </td></tr>        
                                                        </table>
                                                    </div>
                                                </div>                                                            
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190111-0001'>#DPT-20190111-0001</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_123" style="margin-top: 5px;"><input type="radio" name="status_123" id_trf="123" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_123" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190110-0001'>#DPT-20190110-0001</a></td></tr>
                                                ...
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_122" style="margin-top: 5px;"><input type="radio" name="status_122" id_trf="122" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_122" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                                ...
                                                <div class="col-md-4">
                                                    <div align="right">
                                                        <table>
                                                            <tr><td>
                                                                    <b>Bukti Pembayaran:</b>
                                                                <div class="zoom"><img src="http://192.168.43.183/laundry/uploads/konfirmasi/12347698.jpg" height="250" width="250" /> </div>    
                                                            </td></tr>        
                                                        </table>
                                                    </div>
                                                </div>                                                            
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190109-0003'>#DPT-20190109-0003</a></td></tr>
                                                        <tr><td><b>Transfer</b>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>:</b> 200,000</td></tr>                                                                    
                                                    </table>
                                                </div>
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_121" style="margin-top: 5px;"><input type="radio" name="status_121" id_trf="121" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_121" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                                ...
                                                <div class="col-md-4">
                                                    <div align="right">
                                                        <table>
                                                            <tr><td>
                                                                    <b>Bukti Pembayaran:</b>
                                                                <div class="zoom"><img src="http://192.168.43.183/laundry/uploads/konfirmasi/81397642.jpg" height="250" width="250" /> </div>    
                                                            </td></tr>        
                                                        </table>
                                                    </div>
                                                </div>                                                            
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Kode Trx</b> </td><td><b>:</b> <a href='http://192.168.43.183/laundry/adminweb/pemesanan/edit.php?id=DPT-20190109-0002'>#DPT-20190109-0002</a></td></tr>
                                                        <tr><td><b>Transfer</b>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>:</b> 200,000</td></tr>                                                                    
                                                    </table>
                                                </div>
                                                <div class="col-md-4">
                                                    <table width="100%">
                                                        ...
                                                        <tr><td><b>Status</b> </td><td><b>:</b>                                                                 <label id="status_valid_120" style="margin-top: 5px;"><input type="radio" name="status_120" id_trf="120" value="2" checked />&nbsp;&nbsp;<span class="label bg-green" style="font-size: 9pt;">VALID</span>&nbsp;&nbsp;</label>
                                                                ...
                                                                <img id="i_loading_120" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" style="display: none;" />
                                                                                                                    <tr><td colspan="2">
                                                ...
                                                <div class="col-md-4">
                                                    <div align="right">
                                                        <table>
                                                            <tr><td>
                                                                    <b>Bukti Pembayaran:</b>
                                                                <div class="zoom"><img src="http://192.168.43.183/laundry/uploads/konfirmasi/97348621.jpg" height="250" width="250" /> </div>    
                                                            </td></tr>        
                                                        </table>
                                                    </div>
                                                </div>                                                            
...
<script type="text/javascript" src="http://192.168.43.183/laundry/templates/back-end/penguin/js/jzoom.js"></script>
<!-- iCheck -->
