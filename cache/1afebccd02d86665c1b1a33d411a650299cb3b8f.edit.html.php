<?php /*%%SmartyHeaderCode:20330874695be54ccdacfef4-49946204%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1afebccd02d86665c1b1a33d411a650299cb3b8f' => 
    array (
      0 => '../../templates/back-end/penguin/category/edit.html',
      1 => 1538456116,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '20330874695be54ccdacfef4-49946204',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5be54eb77af241_86906282',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5be54eb77af241_86906282')) {function content_5be54eb77af241_86906282($_smarty_tpl) {?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
								...
								<div class="form-group panel-body no-padding-bottom">
									<div class="row">                    
														...
														<div class="form-group">
															...
															<select id="induk" class="form-control" name="id_parent">

																<option value="0" >-- Pilih Kategori --</option>

																
																<option value="38" >Beauty and Care</option>                                        

																
																<option value="12" >Elektronik</option>                                        

																
																<option value="17" >Fashion anak</option>                                        

																
																<option value="10" >Fashion Pria</option>                                        

																
																<option value="6" >Fashion Wanita</option>                                        

																
																<option value="14" >Hobi</option>                                        

																
																<option value="3" >Home & Living</option>                                        

																
																<option value="37" >HP dan Aksesoris</option>                                        
																...
																<option value="11" >Komputer</option>                                        

																
																<option value="2" >Kuliner</option>                                        

																
																<option value="20" >Mobil dan aksesoris</option>                                        

																
																<option value="21" >Motor</option>                                        

																
																<option value="15" >Olah Raga</option>                                        

																
																<option value="18" >Perlengkapan Bayi</option>                                        

																
																<option value="23" >Perlengkapan Kantor</option>                                        

																
																<option value="19" >Rumah Tangga</option>                                        

																
																<option value="1" >Second Pede</option>                                        

																
																<option value="16" >Sepeda</option>                                        

																
															</select>
                                                                                                                        <select id="level1" class="form-control" name="level_1" >
    ...
    <script type="text/javascript">
        $(function () {           
            ...
            $('.image-editor').cropit({
              smallImage: 'stretch',
              imageState: {
                src: 'http://laundry.id/uploads/category/default.png',
              }
            });
            
            
            $('#induk').on('change', function (e) {

                loadLevel_1(this.value);
            ...
            $('#level1').on('change', function (e) {
                ...
                loadLevel_2(this.value, 0);

            });

            function loadLevel_1(induk) {
                $("#level1").empty();
                $('<option value="0">-- Pilih Sub Kategori --</option>').appendTo('#level1');
                
                $.ajax({
                    type: 'POST',
                    url: 'http://laundry.id/store/getKategori.php',
                    data: { 'induk': induk },
                    dataType: 'json',
                    success: function(data) {
                        var store = data['topics'];
                        var data = '<option value="0">-- Pilih Sub Kategori --</option>';
                        for(var key in store) {
                            data+='<option value="'+store[key]['id']+'">'+store[key]['nama']+'</option>';
                        }
                        $("#level1").empty();
                        $(data).appendTo('#level1');
                    }
                });    
            }            
            ...
            $('#btn_submit').click(function() {
                ...
                data.append('level_1', $('[name=level_1]').val());
                //data.append('level_2', $('[name=level_2]').val());
