<?php /*%%SmartyHeaderCode:11470066395ea4fe21075b35-58490314%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a3506f070965d4e013a2f5f1b71ee83c82915482' => 
    array (
      0 => '../../../templates/back-end/penguin/pesanandalamproses/list_pesanantelahdikirim.html',
      1 => 1538456116,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '11470066395ea4fe21075b35-58490314',
  'variables' => 
  array (
    'title' => 0,
    'adminweburl' => 0,
  ...
  'unifunc' => 'content_5ea4fe21196183_73000538',
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ea4fe21196183_73000538')) {function content_5ea4fe21196183_73000538($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
			...
			<div class="header">
				<div class="header-content">
					<div class="page-title">
						<i class="icon-table position-left"></i> Pesanan Telah Dikirim
					</div>
					<ul class="breadcrumb">
						<li><a href="http://kiezie.web.id/laundry/adminweb">Beranda</a></li>
						<li><a href="http://kiezie.web.id/laundry/adminweb/pesanandalamproses/pesanantelahdikirim/">Pesanan Telah Dikirim</a></li>
						<li class="active">Daftar Pesanan Telah Dikirim</li>
					</ul>					
				</div>
			</div>		
			<!--/Page Header-->
						...
						<table class="table table-togglable table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="15%" style="text-align: left;">Pelanggan</th>
                                        <th width="25%" style="text-align: left;">Keterangan</th>
                                        <th width="10%" style="text-align: left;">No. Resi</th>
                                ...
                                <tbody>
                                        ...
                                        <tr id="baris_51">
                                            ...
                                            <td align="left">030085712780</td>
                                            <td align="right">Rp. 207,500</td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="51" class="btn btn-default detail">Cetak</div>&nbsp;&nbsp;                                                    <div id_select="51" class="btn btn-success edit">Edit</div>                                                 
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_39">
                                            ...
                                            <td align="left">
                                                                                                <span class="btn label bg-green"><small>Transfer Bank</small></span>                                            </td>
                                            <td align="left">011910191821817</td>
                                            <td align="right">Rp. 111,000</td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="39" class="btn btn-default detail">Cetak</div>&nbsp;&nbsp;                                                    <div id_select="39" class="btn btn-success edit">Edit</div>                                                 
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_15">
                                            ...
                                            <td align="center">000015</td>
                                            <td align="left">Halima Tussa Diyyah</td>
                                            <td align="left">
                                                                                                <span class="btn label bg-green"><small>Transfer Bank</small></span>                                            </td>
                                            <td align="left">3432424324</td>
                                            <td align="right">Rp. 1,762,750</td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="15" class="btn btn-default detail">Cetak</div>&nbsp;&nbsp;                                                    <div id_select="15" class="btn btn-success edit">Edit</div>                                                 
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_13">
                                            ...
                                            <td align="center">000013</td>
                                            <td align="left">Halima Tussa Diyyah</td>
                                            <td align="left">
                                                                                                <span class="btn label bg-green"><small>Transfer Bank</small></span>                                            </td>
                                            <td align="left">SUBL30012232322</td>
                                            <td align="right">Rp. 592,000</td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="13" class="btn btn-default detail">Cetak</div>&nbsp;&nbsp;                                                    <div id_select="13" class="btn btn-success edit">Edit</div>                                                 
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_11">
                                            ...
                                            <td align="left">
                                                                                                <span class="btn label bg-green"><small>Transfer Bank</small></span>                                            </td>
                                            <td align="left">030075453135</td>
                                            <td align="right">Rp. 263,500</td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="11" class="btn btn-default detail">Cetak</div>&nbsp;&nbsp;                                                    <div id_select="11" class="btn btn-success edit">Edit</div>                                                 
                                                </div>
                                            </td>                                          
                                        </tr>
...
//            $('.tanggal').datepick({ dateFormat: 'dd-mm-yyyy' });
            ...
            $( ".edit" ).click(function() {
                ...
                window.location='http://kiezie.web.id/laundry/adminweb/pemesanan/edit.php?id='+id+'&from_page=pesanantelahdikirim';
