<?php /*%%SmartyHeaderCode:14931996015e9bd885633f05-66262785%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7a5058e46b5d2411b780067c1ea7b5ab3f2f08a0' => 
    array (
  ...
  'nocache_hash' => '14931996015e9bd885633f05-66262785',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5e9bde5d86b0a4_16189542',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e9bde5d86b0a4_16189542')) {function content_5e9bde5d86b0a4_16189542($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
    ...
    <body class="material-menu" id="top">
					...
					<div id="wrapper" class="col-md-12">
							...
							<!---- BUKA ---->
				                    ...
				                    <div class="form-group">
				                        ...
				                        <input type="text" value="001" class="form-control" name="kode" placeholder="" />
				                    </div>

				                    <div class="form-group">
				                        <label for="nama">Nama Produk:</label>
				                        <input type="text" value="Cuci Setrika Lengkap" class="form-control" name="nama" placeholder="" />
				                    </div>
				                    ...
				                    <div class="form-group">
				                        ...
				                        <input type="text" value="6,500" class="form-control harga" name="harga_jual_umum" placeholder="" />
				                    </div>
				                    ...
				                    <div class="form-group">
				                        ...
				                        <input type="file" id="fileupload_foto_1" name="fileupload_foto_1" multiple />
				                    				                        				                        ...
				                    				                        				                        <div class="form-group">
				                            <img id="preview_foto_1" src="http://192.168.43.183/laundry/uploads/produk/index.jpg" style="height: 300px;" alt="1" />
				                        ...
				                        <table>
				                            <tbody>
				                                <tr>
				                                    <td width="100%">&nbsp;</td> 
				                                    <td nowrap>
				                                        <div id="i_loading" class="G-btn-animation" style="display: none;"><img src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/img/loading.gif" /></div>                  
		...
		<!-- Page scripts -->
		<script src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/bootstrap-fileinput/js/fileinput.js"></script>
		<script type="text/javascript" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/js/jquery.input.formatter.js"></script>  

		<!-- include summernote -->
		<link rel="stylesheet" href="http://192.168.43.183/laundry/templates/back-end/penguin/assets/dist/summernote.css">
		<script type="text/javascript" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/dist/summernote.js"></script>
		<script type="text/javascript" src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/dist/summernote-ext-video.js"></script> 
		<link href="http://192.168.43.183/laundry/templates/back-end/penguin/assets/datepick/jquery.datepick.css" rel="stylesheet">
		<script src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/datepick/jquery.plugin.js"></script>
		<script src="http://192.168.43.183/laundry/templates/back-end/penguin/assets/datepick/jquery.datepick.js"></script>
		...
		<script type="text/javascript">
	        ...
	        $(function () {           
	            ...
	            $(".summernote").code('Paket Cuci Setrika Lengkap');
