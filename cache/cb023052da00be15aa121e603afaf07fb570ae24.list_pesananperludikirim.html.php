<?php /*%%SmartyHeaderCode:18717286495eea0a2c2338f4-07398256%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cb023052da00be15aa121e603afaf07fb570ae24' => 
    array (
      0 => '../../../templates/back-end/penguin/pesanandalamproses/list_pesananperludikirim.html',
      1 => 1592350419,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18717286495eea0a2c2338f4-07398256',
  'variables' => 
  array (
    'title' => 0,
    'adminweburl' => 0,
  ...
  'unifunc' => 'content_5eea0a2c2f9ce4_60147964',
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eea0a2c2f9ce4_60147964')) {function content_5eea0a2c2f9ce4_60147964($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
			...
			<div class="header">
				<div class="header-content">
					...
					<ul class="breadcrumb">
						...
						<li><a href="http://kiezie.web.id/bekamonline/adminweb/pesanandalamproses/pesananperludikirim/">Pesanan Perlu Dikirim</a></li>
						...
						<table class="table table-togglable table-hover">
                                ...
                                <tbody>
                                        ...
                                        <tr id="baris_12">
                                            ...
                                            <td align="left">
                                                                                                <span class="btn label bg-green"><small>Transfer Bank</small></span>                                            </td>
                                            <td align="right">Rp. 1,713,000</td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="12" class="btn btn-default detail">Cetak</div>&nbsp;&nbsp;                                                    <div id_select="12" class="btn btn-success edit">Edit</div>                                                 
                                                </div>
                                            </td>                                          
                                        </tr>
...
//            $('.tanggal').datepick({ dateFormat: 'dd-mm-yyyy' });
            ...
            $( ".edit" ).click(function() {
                ...
                window.location='http://kiezie.web.id/bekamonline/adminweb/pemesanan/edit.php?id='+id+'&from_page=pesananperludikirim';
            ...
            $( ".detail" ).click(function() {
                ...
                window.open('http://kiezie.web.id/bekamonline/adminweb/cetak.php?kode='+id,'cetak_faktur','width=715,height=565,toolbar=no,menubar=no,scrollbars=yes');
