...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5eebf5cb3bd853_45198448',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eebf5cb3bd853_45198448')) {function content_5eebf5cb3bd853_45198448($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
			...
			<div class="header">
				<div class="header-content">
					...
					<ul class="breadcrumb">
						...
						<li><a href="http://kiezie.web.id/bekamonline/adminweb/dashboard/">Product</a></li>
                            ...
                            <tbody>
                                    ...
                                    <tr id="baris_1">
                                        ...
                                        <td align="left">
                                            ...
                                            <img align="left" style="margin-right: 10px; margin-bottom: 10px; margin-top: 3px;" src="http://kiezie.web.id/bekamonline/uploads/produk/cop +darah_3.jpeg" width="75" />
                                    ...
                                    <tr id="baris_2">
                                        ...
                                        <td align="left">
                                            ...
                                            <img align="left" style="margin-right: 10px; margin-bottom: 10px; margin-top: 3px;" src="http://kiezie.web.id/bekamonline/uploads/produk/cop +darah_2.jpeg" width="75" />
                                    ...
                                    <tr id="baris_3">
                                        ...
                                        <td align="left">
                                            ...
                                            <img align="left" style="margin-right: 10px; margin-bottom: 10px; margin-top: 3px;" src="http://kiezie.web.id/bekamonline/uploads/produk/cop +darah_1.jpeg" width="75" />
                                    ...
                                    <tr id="baris_4">
                                        ...
                                        <td align="left">
                                            ...
                                            <img align="left" style="margin-right: 10px; margin-bottom: 10px; margin-top: 3px;" src="http://kiezie.web.id/bekamonline/uploads/produk/cop +darah.jpeg" width="75" />
