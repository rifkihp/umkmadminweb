<?php /*%%SmartyHeaderCode:3718284735ee957c26a6903-32120580%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '01a8f87183a2ae62a0187c96e4c2c32c3d3a6c8a' => 
    array (
  ...
  'nocache_hash' => '3718284735ee957c26a6903-32120580',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5eef0a5fdd8ac1_84387659',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eef0a5fdd8ac1_84387659')) {function content_5eef0a5fdd8ac1_84387659($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
			...
			<div class="header">
				<div class="header-content">
					...
					<ul class="breadcrumb">
						...
						<li><a href="http://kiezie.web.id/bekamonline/adminweb/dashboard/">Dashboard</a></li>
					...
					<div class="col-md-3">
						<div class="panel panel-flat">
							<div class="panel-body p-b-10">
								<div class="row">
									<div class="col-md-8 col-xs-8">
										<div class="text-size-huge text-regular text-amber-dark text-semibold no-padding no-margin m-t-5 m-b-10">135</div>
						...
						<table class="table table-hover user-list">
							...
							<tbody>
									...
									<tr id="baris_36">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000036" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_34">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000034" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_31">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000031" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_29">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000029" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_30">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000030" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_7">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000007" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_38">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000038" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_64">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000064" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_56">
										...
										<td align="left">26-01-2018</td>

										<td align="left">#000056 </td>

										<td align="left">Tamu</td>

										<td align="left">1 Pcs</td>

										<td align="left">Rp. 3,042,900</td>

										<td><div style="text-align: center;  white-space: nowrap;">

												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000056" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_57">
										...
										<td align="left">29-01-2018</td>

										<td align="left">#000057 <span class="label label-danger">DROPSHIP</span></td>

										<td align="left">Tamu</td>

										<td align="left">1 Pcs</td>

										<td align="left">Rp. 141,000</td>

										<td><div style="text-align: center;  white-space: nowrap;">

												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000057" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_58">
										...
										<td align="left">Rp. 196,000</td>

										<td><div style="text-align: center;  white-space: nowrap;">

												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000058" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_59">
										...
										<td align="left">#000059 <span class="label label-danger">DROPSHIP</span></td>

										<td align="left">Tamu</td>

										<td align="left">1 Pcs</td>

										<td align="left">Rp. 60,900</td>

										<td><div style="text-align: center;  white-space: nowrap;">

												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000059" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_60">
										...
										<td align="left">#000060 </td>

										<td align="left">Tamu</td>

										<td align="left">1 Pcs</td>

										<td align="left">Rp. 67,900</td>

										<td><div style="text-align: center;  white-space: nowrap;">

												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000060" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_65">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000065" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_67">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000067" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_68">
										...
										<td align="left">#000068 </td>

										<td align="left">Tamu</td>

										<td align="left">1 Pcs</td>

										<td align="left">Rp. 309,000</td>

										<td><div style="text-align: center;  white-space: nowrap;">

												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000068" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_69">
										...
										<td align="left">03-03-2018</td>

										<td align="left">#000069 </td>

										<td align="left"></td>

										<td align="left">1 Pcs</td>

										<td align="left">Rp. 156,000</td>

										<td><div style="text-align: center;  white-space: nowrap;">

												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000069" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_71">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000071" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_73">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000073" class="btn btn-success update">Detail</a>
									...
									<tr id="baris_74">
										...
										<td><div style="text-align: center;  white-space: nowrap;">
												...
												<a href="http://kiezie.web.id/bekamonline/adminweb/pemesanan/list.php?query=000074" class="btn btn-success update">Detail</a>
							...
							<tfoot><tr><th colspan="8">
								...
								<div style="text-align: center;">
											...
											<a class="btn btn-default" href="http://kiezie.web.id/bekamonline/adminweb/dashboard/index.php?page_pemesanan=2&page_stok=1&page_konfirmasi=1">2</a>
											...
											<a class="btn btn-default" href="http://kiezie.web.id/bekamonline/adminweb/dashboard/index.php?page_pemesanan=3&page_stok=1&page_konfirmasi=1">3</a>
										...
										<a class="btn btn-default" href="http://kiezie.web.id/bekamonline/adminweb/dashboard/index.php?page_pemesanan=2&page_stok=1&page_konfirmasi=1">Next &rarr;</a>
				...
				<div class="rightbar-container">
					<div class="right-chat-bar">
						<div class="coversation-header">
							...
							<div class="active-conversation">
								<div class="chat-avatar">
									<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/faces/face12.png" alt="user">
								</div>
						...
						<div class="conversation-container">
							...
							<div class="conversation-row even">
								<ul class="conversation-list">
									<li>						
										<a href="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/demo/pic7.jpg" class="venobox"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/demo/pic7.jpg" alt=""/></a>
									</li>
								</ul>
							</div>
							<div class="conversation-row odd">
					...
					<div class="chat-user-container">			
						<ul class="chat-user-list">
							<li>
								<div><span class="chat-avatar"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/faces/face1.png" alt="Avatar"></span><span class="chat-u-info">Jane Elliott<cite>Li Europan lingues es...</cite></span>
								</div>
								<span class="chat-u-status"><i class="icon icon-circles"></i></span>
							</li>
							<li>
								<div><span class="chat-avatar"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/faces/face2.png" alt="Avatar"></span><span class="chat-u-info">Florence Douglas<cite>Busy</cite></span>
								</div>
								<span class="chat-u-status"><i class="icon icon-circles"></i></span>
							</li>
							<li class="chat-u-online">
								<div><span class="chat-avatar"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/faces/face3.png" alt="Avatar"></span><span class="chat-u-info">Jacqueline Howell<cite>Available</cite></span>
								</div>
								<span class="chat-u-status"><i class="icon icon-circles"></i></span>
							</li>
							<li class="chat-u-online">
								<div><span class="chat-avatar"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/faces/face4.png" alt="Avatar"></span><span class="chat-u-info">Eugine Turner<cite>Occidental in fact...</cite></span>
								</div>
								<span class="chat-u-status"><i class="icon icon-circles"></i></span>
							</li>
							<li class="chat-u-busy">
								<div><span class="chat-avatar"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/faces/face5.png" alt="Avatar"></span><span class="chat-u-info">Andrew Brewer<cite>Busy</cite></span>
								</div>
								<span class="chat-u-status"><i class="icon icon-circles"></i></span>
							</li>
							<li class="chat-u-away">
								<div><span class="chat-avatar"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/faces/face6.png" alt="Avatar"></span><span class="chat-u-info">Jonaly Smith<cite>Available</cite></span>
								</div>
								<span class="chat-u-status"><i class="icon icon-circles"></i></span>
							</li>
							<li class="chat-u-online">
								<div><span class="chat-avatar"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/faces/face7.png" alt="Avatar"></span><span class="chat-u-info">Ann Porter<cite>Available</cite></span>
								</div>
								<span class="chat-u-status"><i class="icon icon-circles"></i></span>
							</li>
							<li class="chat-u-away">
								<div><span class="chat-avatar"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/faces/face8.png" alt="Avatar"></span><span class="chat-u-info">John Deo<cite>Do not disturb</cite></span>
								</div>
								<span class="chat-u-status"><i class="icon icon-circles"></i></span>
							</li>
							<li>
								<div><span class="chat-avatar"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/faces/face9.png" alt="Avatar"></span><span class="chat-u-info">Marilyn Romero<cite>On refusa continuar payar...</cite></span>
								</div>
								<span class="chat-u-status"><i class="icon icon-circles"></i></span>
							</li>
							<li>
								<div><span class="chat-avatar"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/faces/face10.png" alt="Avatar"></span><span class="chat-u-info">Carol Gibson<cite>Gone for a weekend</cite></span>
								</div>
								<span class="chat-u-status"><i class="icon icon-circles"></i></span>
							</li>
							<li>
								<div><span class="chat-avatar"><img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/faces/face11.png" alt="Avatar"></span><span class="chat-u-info">Scott Ruiz<cite>At solmen va esser...</cite></span>
								</div>
								<span class="chat-u-status"><i class="icon icon-circles"></i></span>
							</li>
						</ul>						
			...
			<ul class="switch-theme-colors clearfix">
				...
				<li>
					<div class="theme" id="light">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/light.jpg" alt=""/>
					</div>				
				</li>
				<li class="list-title clearfix">Mirage</li>
				<li>
					<div class="theme pull-left" id="mirage">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/mirage_dark.jpg" alt=""/>
					</div>				
				</li>			
				<li>
					<div class="theme pull-left" id="mirage_light">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/mirage_light.jpg" alt=""/>
					</div>				
				</li>
				<li>
					<div class="theme pull-left" id="mirage_light_sidebar">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/mirage_light_sidebar.jpg" alt=""/>
					</div>				
				</li>										
				<li class="list-title clearfix">Burnt Sienna</li>
				<li>
					<div class="theme pull-left" id="burnt_sienna_dark">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/burnt_sienna_dark.jpg" alt=""/>
					</div>				
				</li>			
				<li>
					<div class="theme pull-left" id="burnt_sienna_light">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/burnt_sienna_light.jpg" alt=""/>
					</div>				
				</li>
				<li>
					<div class="theme pull-left" id="burnt_sienna_light_sidebar">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/burnt_sienna_light_sidebar.jpg" alt=""/>
					</div>				
				</li>		
				...
				<li>
					<div class="theme pull-left" id="amethyst_dark">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/amethyst_dark.jpg" alt=""/>
					</div>				
				</li>			
				<li>
					<div class="theme pull-left" id="amethyst_light">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/amethyst_light.jpg" alt=""/>
					</div>				
				</li>
				<li>
					<div class="theme pull-left" id="amethyst_light_sidebar">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/amethyst_light_sidebar.jpg" alt=""/>
					</div>				
				</li>		
				...
				<li>
					<div class="theme pull-left" id="fuchsiablue_dark">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/fuchsiablue_dark.jpg" alt=""/>
					</div>				
				</li>			
				<li>
					<div class="theme pull-left" id="fuchsiablue_light">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/fuchsiablue_light.jpg" alt=""/>
					</div>				
				</li>
				<li>
					<div class="theme pull-left" id="fuchsiablue_light_sidebar">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/fuchsiablue_light_sidebar.jpg" alt=""/>
					</div>				
				</li>
				...
				<li>
					<div class="theme pull-left" id="pictonblue_dark">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/pictonblue_dark.jpg" alt=""/>
					</div>				
				</li>			
				<li>
					<div class="theme pull-left" id="pictonblue_light">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/pictonblue_light.jpg" alt=""/>
					</div>				
				</li>
				<li>
					<div class="theme pull-left" id="pictonblue_light_sidebar">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/pictonblue_light_sidebar.jpg" alt=""/>
					</div>				
				</li>
				...
				<li>
					<div class="theme pull-left" id="junglegreen_dark">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/junglegreen_dark.jpg" alt=""/>
					</div>				
				</li>			
				<li>
					<div class="theme pull-left" id="junglegreen_light">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/junglegreen_light.jpg" alt=""/>
					</div>				
				</li>
				<li>
					<div class="theme pull-left" id="junglegreen_light_sidebar">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/junglegreen_light_sidebar.jpg" alt=""/>
					</div>				
				</li>
				...
				<li>
					<div class="theme pull-left" id="fern_dark">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/fern_dark.jpg" alt=""/>
					</div>				
				</li>			
				<li>
					<div class="theme pull-left" id="fern_light">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/fern_light.jpg" alt=""/>
					</div>				
				</li>
				<li>
					<div class="theme pull-left" id="fern_light_sidebar">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/fern_light_sidebar.jpg" alt=""/>
					</div>				
				</li>
				...
				<li>
					<div class="theme pull-left" id="sunglow_dark">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/sunglow_dark.jpg" alt=""/>
					</div>				
				</li>			
				<li>
					<div class="theme pull-left" id="sunglow_light">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/sunglow_light.jpg" alt=""/>
					</div>				
				</li>
				<li>
					<div class="theme pull-left" id="sunglow_light_sidebar">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/sunglow_light_sidebar.jpg" alt=""/>
					</div>				
				</li>
				...
				<li>
					<div class="theme pull-left" id="regentgrey_dark">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/regentgrey_dark.jpg" alt=""/>
					</div>				
				</li>			
				<li>
					<div class="theme pull-left" id="regentgrey_light">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/regentgrey_light.jpg" alt=""/>
					</div>				
				</li>
				<li>
					<div class="theme pull-left" id="regentgrey_light_sidebar">
						<img src="http://kiezie.web.id/bekamonline/templates/back-end/penguin/assets/images/themes/regentgrey_light_sidebar.jpg" alt=""/>
					</div>				
				</li>
			</ul>	
		</div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.ajax({
                ...
                url: 'http://kiezie.web.id/bekamonline/adminweb/dashboard/statistikpenjualan.php',
