...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5e8596962ca542_08525317',
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e8596962ca542_08525317')) {function content_5e8596962ca542_08525317($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
    ...
    <div class="header">
        <div class="header-content">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="http://localhost/laundry/adminweb/metode_pembayaran/">Pengaturan</a></li>
                                ...
                                <tbody>
                                        ...
                                        <tr id="baris_4">
                                            ...
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://localhost/laundry/uploads/bank/muamalat_2121.png" width="75" />
                                            </div></td>
                                            <td>
