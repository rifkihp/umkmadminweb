...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5d688101750341_87843470',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d688101750341_87843470')) {function content_5d688101750341_87843470($_smarty_tpl) {?><!doctype html>
<html lang="en">
    <head>
	<meta charset="UTF-8">
			...
			<div class="header">
				<div class="header-content">
					...
					<ul class="breadcrumb">
						...
						<li><a href="http://laundry.id/adminweb/pesanandalamproses/pesananperludikirim/">Pesanan Perlu Dikirim</a></li>
...
//            $('.tanggal').datepick({ dateFormat: 'dd-mm-yyyy' });
            ...
            $( ".edit" ).click(function() {
                ...
                window.location='http://laundry.id/adminweb/pemesanan/edit.php?id='+id+'&from_page=pesananperludikirim';
